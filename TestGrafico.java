...
public class TestGrafico extends Frame {
    public int tipoGrafico = 3; // 0: Biblioteca, 1: Barras, 2: Pastel, 3: Lineal, 4: Dispersion, 5: Radar
    private DiagramaBiblioteca graficaBiblioteca;
    public int[] valores = {4, 5, 2, 6, 7, 3, 9 };
    public String[] etiquetas = { "Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio"};
    ...
    public void crearGrafico() {
        // Limpiar cualquier componente previo
        removeAll();
        ...
        // Asegurar que los cambios se reflejen en la interfaz
        validate();
        repaint();
    }
